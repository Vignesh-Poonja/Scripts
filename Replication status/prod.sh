...
declare -A DB_USERS=( ["UUP"]="uupadm" ["SRP"]="srpadm" ["USP"]="uspadm" )
declare -A DB_INSTANCES=( ["UUP"]="90" ["SRP"]="91" ["USP"]="93" )
declare -A DB_REGISTER=(
  ["UUP"]="hdbnsutil -sr_register --name=SecondaryUUP --remoteHost=uvuhanprddb --remoteInstance=90 --replicationMode=syncmem --operationMode=logreplay"
  ["SRP"]="hdbnsutil -sr_register --name=SecondarySRP --remoteHost=uvuhanprddb --remoteInstance=91 --replicationMode=syncmem --operationMode=logreplay"
  ["USP"]="hdbnsutil -sr_register --name=SecondaryUSP --remoteHost=uvuhanprddb --remoteInstance=93 --replicationMode=syncmem --operationMode=logreplay"
)
